...
if __name__=="__main__":
    ...
    prepare_run(
        ...
        run_name="debug",
        network_name="kcm",
        train_dates=data_utils.get_date_list("2023_02_18", 1),
        test_dates=data_utils.get_date_list("2023_03_10", 1),
        num_train_files=1,
        num_test_files=1,
        n_jobs=5,
        n_trace_splits=5,
        ...
        epsg="32148",
        grid_x_bounds=[373000,429000],
        grid_y_bounds=[31000, 89000],
        grid_s_res=500,
        grid_t_res=120,
        grid_n_res=3,
    ...
    prepare_run(
        ...
        run_name="debug",
        network_name="atb",
        train_dates=data_utils.get_date_list("2023_03_08", 1),
        test_dates=data_utils.get_date_list("2023_03_20", 1),
        num_train_files=1,
        num_test_files=1,
        n_jobs=5,
        n_trace_splits=5,
