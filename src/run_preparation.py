...
def clean_data(dates, n_save_files, train_or_test, base_folder, **kwargs):
    ...
    for file_num, date_list in enumerate(date_splits):
        ...
        summary_config = data_utils.get_summary_config(traces, kwargs['gtfs_folder'], n_save_files, kwargs['epsg'], kwargs['grid_bounds'], kwargs['coord_ref_center'], kwargs['skip_gtfs'])
    ...
    data_utils.combine_config_files(f"{base_folder}deeptte_formatted/", n_save_files-file_num_mod, train_or_test)
...
if __name__=="__main__":
    ...
    #     run_name="small",
    #     network_name="kcm",
    #     train_dates=data_utils.get_date_list("2023_03_15", 28),
