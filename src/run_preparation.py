...
def clean_data(dates, n_save_files, train_or_test, base_folder, **kwargs):
    ...
    for file_num, date_list in enumerate(date_splits):
        ...
        traces, train_ngrid = data_utils.map_to_deeptte(traces, deeptte_formatted_path, grid_bounds=kwargs['grid_bounds'], grid_s_res=kwargs['grid_s_res'], grid_t_res=kwargs['grid_t_res'], grid_n_res=kwargs['grid_n_res'])
        ...
        data_utils.write_pkl(train_ngrid, f"{base_folder}{train_or_test}{file_num}_ngrid.pkl")
...
if __name__=="__main__":
    ...
    #     test_dates=data_utils.get_date_list("2023_04_01", 3),
    #     num_train_files=2,
    #     num_test_files=2,
    #     n_jobs=2, # <= n_trace_splits
    #     n_trace_splits=2,
    #     data_dropout=0.2,
