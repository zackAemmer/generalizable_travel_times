...
python main.py --task generalize --batch_size 64 --epochs 10 --n_folds $n_folds --result_file ./result/deeptte --pooling_method attention --kernel_size 3 --alpha 0.1 --log_file generalize_log --weight_file ./saved_weights/weights_0 --flag GEN
