...
cp ./results/$run_name/kcm/deeptte_formatted/config.json ../DeepTTE/config.json
# Run Deeptte on validation set for each network
cd ~/Skrivebord/DeepTTE
rm -rf ./result && mkdir ./result
rm -rf ./saved_weights && mkdir ./saved_weights
rm -rf ./logs && mkdir ./logs
cp ../valle/results/$run_name/kcm/deeptte_results/saved_weights/weights_4 ./saved_weights/weights_4
...
### ATB on ATB ###
cp -a ./results/$run_name/atb/deeptte_formatted/* ../DeepTTE/data
cp ./results/$run_name/atb/deeptte_formatted/config.json ../DeepTTE/config.json
# Run Deeptte on validation set for each network
cd ~/Skrivebord/DeepTTE
rm -rf ./result && mkdir ./result
rm -rf ./saved_weights && mkdir ./saved_weights
rm -rf ./logs && mkdir ./logs
cp ../valle/results/$run_name/atb/deeptte_results/saved_weights/weights_4 ./saved_weights/weights_4
