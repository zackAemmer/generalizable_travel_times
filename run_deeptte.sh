...
python main.py --task train --batch_size 10 --epochs 2 --result_file ./result/deeptte --pooling_method attention --kernel_size 3 --alpha 0.1 --log_file train_log
# Copy Deeptte results back to results folder
cd ~/Skrivebord/valle
cp -a ../DeepTTE/result ./results/debug/kcm/deeptte_results/
cp -a ../DeepTTE/saved_weights ./results/debug/kcm/deeptte_results/
